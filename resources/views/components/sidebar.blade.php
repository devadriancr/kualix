<aside class="fixed top-0 left-0 h-screen w-64 bg-white shadow-lg z-50 flex flex-col justify-between border-r border-gray-200">

    <!-- Encabezado con borde sutil -->
    <div>
    <div class="p-6 border-b border-gray-100">
        <a href="{{ route('dashboard') }}" class="text-2xl font-bold text-center block transition-colors hover:opacity-80">
        ...
        <nav class="mt-6 px-4 space-y-1">
            ...
            <a href="{{ route('label-scan') }}"
               class="{{ request()->routeIs('label-scan') ? 'bg-indigo-50 text-indigo-600 border-l-4 border-indigo-500' : 'text-gray-600 hover:bg-gray-50' }} flex items-center gap-3 px-3 py-3 rounded-r-lg transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <!-- Otro Enlace -->
            <a href="#" class="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <div class="p-4 border-t border-gray-200">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
