                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-2">
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <!-- value = id -->
                                        <input id="permission_{{ $permission->id }}" name="permissions[]" type="checkbox" value="{{ $permission->id }}" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ in_array($permission->id, old('permissions', [])) ? 'checked' : '' }}>
                                    </div>
